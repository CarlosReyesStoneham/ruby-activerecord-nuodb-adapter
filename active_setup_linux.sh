...
sed -i "s/require MIGRATIONS_ROOT + "/valid/2_we_need_reminders"/require_relative MIGRATIONS_ROOT + '/valid/2_we_need_reminders'/" ~/tmpy/rails-latest/activerecord/test/cases/migration_test.rb
sed -i "s/require MIGRATIONS_ROOT + "/rename/1_we_need_things"/require_relative MIGRATIONS_ROOT + '/rename/1_we_need_things'/" ~/tmpy/rails-latest/activerecord/test/cases/migration_test.rb
sed -i "s/require MIGRATIONS_ROOT + "/valid/2_we_need_reminders"'/require_relative MIGRATIONS_ROOT + "/valid/2_we_need_reminders"/" ~/tmpy/rails-latest/activerecord/test/cases/migration_test.rb
sed -i "s/require MIGRATIONS_ROOT + "/decimal/1_give_me_big_numbers"/require_relative MIGRATIONS_ROOT + "/decimal/1_give_me_big_numbers"/" ~/tmpy/rails-latest/activerecord/test/cases/migration_test.rb
